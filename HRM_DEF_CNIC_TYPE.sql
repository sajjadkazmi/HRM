...
/****** Object:  Table [dbo].[ADM_DEF_CNIC_TYPE]    Script Date: 02/01/2020 21:19:12 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[HRM_DEF_CNIC_TYPE](
	[CODE] [numeric](10, 0) NOT NULL,
	[DESC] [varchar](max) NULL DEFAULT (''),
	[TYPE] [varchar](5) NULL DEFAULT (''),
 ...
 CONSTRAINT [PK_HRM_DEF_CNIC_TYPE] PRIMARY KEY CLUSTERED 
(
	[CODE] DESC
